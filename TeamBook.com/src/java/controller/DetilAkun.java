 ...
 * @author moh.afifun
 */
public class DetilAkun extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetilAkun</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetilAkun at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        processRequest(request, response);
        ...
        Akun akun = dao.getAkun(id);
        
        request.setAttribute("akun", akun);
        request.getRequestDispatcher("detil-akun.jsp").forward(request, response);
    }
